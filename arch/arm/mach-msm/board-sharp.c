...
#else
#define MSM_FB_SIZE		((544 * 960 * 4 * 2) + SHHDMI_FB_SIZE)
#endif
#else
#define MSM_FB_SIZE		0x500000
#endif /*CONFIG_SHLCDC_BOARD*/
#ifndef CONFIG_SH_CAMERA
#if defined(CONFIG_MACH_DECKARD_AS36) || defined(CONFIG_MACH_DECKARD_AF30) || defined(CONFIG_MACH_DECKARD_AF21) || defined(CONFIG_MACH_KOH) || defined(CONFIG_MACH_LYNX_DC55) || defined(CONFIG_MACH_DECKARD_AF30) || defined(CONFIG_MACH_TGS)
#define MSM_PMEM_ADSP_SIZE      0x3500000
#else
#define MSM_PMEM_ADSP_SIZE      0x1800000
#endif /* CONFIG_MACH_DECKARD_AS36 || CONFIG_MACH_DECKARD_AF30 || CONFIG_MACH_DECKARD_AF21 || CONFIG_MACH_KOH || CONFIG_MACH_LYNX_DC55 || CONFIG_MACH_DECKARD_AF30 || CONFIG_MACH_TGS */
#else
#if defined( CONFIG_MACH_DECKARD_AF20 ) || defined( CONFIG_MACH_DECKARD_AS35 ) || defined( CONFIG_MACH_LYNX_DC45 ) || defined( CONFIG_MACH_NSK )
#define MSM_PMEM_ADSP_SIZE      0x3500000
#else
#ifdef CONFIG_MACH_RYK
...
#if defined (CONFIG_MATRIX2_KEYPAD)
...
#if defined(CONFIG_SENSORS_AMI602) || defined(CONFIG_MPU_SENSORS_MPU3050)
#else
...
#if defined(CONFIG_SENSORS_AMI602) || defined(CONFIG_MPU_SENSORS_MPU3050) || defined(CONFIG_SH_CAMERA) || defined(CONFIG_I2C_CUST_SH)
#else
GPIO_CFG(1, 0, GPIO_CFG_OUTPUT, GPIO_CFG_PULL_DOWN, GPIO_CFG_2MA), /* VCM */
#endif	/* CONFIG_SENSORS_AMI602 || CONFIG_MPU_SENSORS_MPU3050 || CONFIG_SH_CAMERA || CONFIG_I2C_CUST_SH */
};
...
static uint32_t camera_off_gpio_table[] = {
	...
	GPIO_CFG(15, 0, GPIO_CFG_OUTPUT, GPIO_CFG_NO_PULL,  GPIO_CFG_2MA), /* MCLK */
	#else
		#if defined(CONFIG_MACH_KOH) || defined(CONFIG_MACH_TGS)
		...
		#endif	/* CONFIG_MACH_KOH */ /* CONFIG_MACH_TGS */
	#endif	/* CONFIG_T8EV4 */
#endif	/* CONFIG_SH_CAMERA */
};
...
#if defined(CONFIG_SH_CAMLED) && !defined(CONFIG_MACH_LYNX_DC55)
	.flash_type = MSM_CAMERA_FLASH_LED,
#else
	.flash_type = MSM_CAMERA_FLASH_NONE,
#endif /* CONFIG_SH_CAMLED && !CONFIG_MACH_LYNX_DC55 */
	.flash_src  = &msm_flash_src_pwm
};
...
static struct usb_mass_storage_platform_data mass_storage_pdata_cd = {
	.nluns		= 1,
	.vendor		= USB_MSC_VENDOR_ID,
	.product    = USB_MSC_CD_PRODUCT_ID,
	.release	= 0x0100,
	.can_stall	= 1,

};

static struct platform_device usb_mass_storage_device_cd = {
	.name	= "usb_mass_storage_cd",
	.id	= -1,
	.dev	= {
		.platform_data = &mass_storage_pdata_cd,
	},
};
...
#if defined( CONFIG_MACH_DECKARD_AF20 ) || defined( CONFIG_MACH_DECKARD_AF21 )
...
#if defined( CONFIG_MACH_DECKARD_AS36 )
...
#endif	/* #if defined( CONFIG_MACH_DECKARD_AS36 ) || defined(CONFIG_MACH_DECKARD_AF21) */
#else
	{ GPIO_CFG(45, 1, GPIO_CFG_OUTPUT, GPIO_CFG_NO_PULL, GPIO_CFG_4MA), "spi_clk" },
	{ GPIO_CFG(47, 1, GPIO_CFG_OUTPUT, GPIO_CFG_NO_PULL, GPIO_CFG_4MA), "spi_mosi" },
...
#ifndef CONFIG_BTPM	 /* BT_001 [Sharp]Disable for btpm implementation */
...
static struct msm_gpio sdc1_cfg_data[] = {
	...
	#if defined(CONFIG_MACH_NSK) || defined(CONFIG_MACH_KOH) || defined(CONFIG_MACH_TGS)
...
static struct msm_gpio sdc2_cfg_data[] = {
		...
		#endif	
	#elif defined(CONFIG_MACH_LYNX_DC55)
...
static void __init msm7x30_init_mmc(void)
{
	...
	if (machine_is_msm8x55_svlte_surf() ||
			machine_is_msm8x55_svlte_ffa()) {
#ifdef CONFIG_MMC_MSM_SDC4_SUPPORT       /* COORDINATOR Qualcomm404021 BUILDERR MODIFY */
		msm7x30_sdc2_data.sdio_lpm_gpio_setup = msm_sdcc_sdio_lpm_gpio;
#endif /* CONFIG_MMC_MSM_SDC4_SUPPORT */ /* COORDINATOR Qualcomm404021 BUILDERR MODIFY */
#ifdef CONFIG_MMC_MSM_SDIO_SUPPORT
...
MACHINE_START(KOH, "SHARP KOH")
	...
	.timer = &msm_timer,
MACHINE_END
MACHINE_START(DSN10, "SHARP DSN10")
#ifdef CONFIG_MSM_DEBUG_UART
	.phys_io  = MSM_DEBUG_UART_PHYS,
	.io_pg_offst = ((MSM_DEBUG_UART_BASE) >> 18) & 0xfffc,
#endif
...
MACHINE_START(TGS, "SHARP TGS")
	...
	.timer = &msm_timer,
MACHINE_END
MACHINE_START(DSN11, "SHARP DSN11")
#ifdef CONFIG_MSM_DEBUG_UART
	.phys_io  = MSM_DEBUG_UART_PHYS,
	.io_pg_offst = ((MSM_DEBUG_UART_BASE) >> 18) & 0xfffc,
#endif
	...
	.timer = &msm_timer,
MACHINE_END
MACHINE_START(DSN12, "SHARP DSN12")
#ifdef CONFIG_MSM_DEBUG_UART
	.phys_io  = MSM_DEBUG_UART_PHYS,
	.io_pg_offst = ((MSM_DEBUG_UART_BASE) >> 18) & 0xfffc,
#endif
...
MACHINE_START(DECKARD_AS36, "SHARP DECKARD AS36")
    ...
    .timer = &msm_timer,
MACHINE_END
MACHINE_START(DECKARD_AF30, "SHARP DECKARD AF30")
    #ifdef CONFIG_MSM_DEBUG_UART
    .phys_io  = MSM_DEBUG_UART_PHYS,
    .io_pg_offst = ((MSM_DEBUG_UART_BASE) >> 18) & 0xfffc,
    #endif
